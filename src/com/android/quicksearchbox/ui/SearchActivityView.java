...
public abstract class SearchActivityView extends RelativeLayout {
    ...
    protected OnClickListener mExitClickListener;
    ...
    protected Drawable getVoiceSearchIcon() {
        return getResources().getDrawable(R.drawable.ic_round_keyboard_voice_24);
    }
    ...
    public void setExitClickListener(final OnClickListener listener) {
     ...
     */
    protected class SuggestionsViewKeyListener implements OnKeyListener {
        @Override
     ...
     */
    private class SearchGoButtonClickListener implements OnClickListener {
        @Override
     ...
     */
    private class ButtonsKeyListener implements OnKeyListener {
        @Override
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            return forwardKeyToQueryTextView(keyCode, event);
        }
